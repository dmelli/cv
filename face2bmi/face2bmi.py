...
@click.command()
@click.option('--layer', default='fc6', help='face model layer')
@click.option('--model', default='vgg16', help='face model')
@click.option('--input_face', default='./face', help='face path')
@click.option('--input_meta', default='./full.csv', help='meta path')
@click.option('--test_face', default='./test', help='face path')
@click.option('--task', default='retrain', help='face path')
@click.option('--split_ratio', default=0.8, help='split ratio')
